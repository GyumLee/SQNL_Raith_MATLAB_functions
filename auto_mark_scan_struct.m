function line_scan_struct = auto_mark_scan_struct(args)
    ...
    for i = 1:num_marks
        ...
        lines.(append('x', num2str(i))).data.uv = [mark_positions(i,1) - line_scan_length/2, mark_positions(i,1) + line_scan_length/2;
                                                mark_positions(i,2) - mark_size/4, mark_positions(i,2) - mark_size/4];
        ...
        lines.(append('y', num2str(i))).data.uv = [mark_positions(i,1) + mark_size/4, mark_positions(i,1) + mark_size/4;
        ...
        line_array_element(2*i) = lines.(append('y', num2str(i)));
        line_array_element(2*i-1) = lines.(append('x', num2str(i)));
